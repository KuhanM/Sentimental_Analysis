...
with st.spinner("Setting up MoodSense..."):
...
def generate_response(user_input, sentiment, confidence, username="Friend"):
    ...
    if "what can you do" in lower_input or "how do you work" in lower_input:
        return f"I'm MoodSense, your emotional analysis companion! I can analyze your mood based on our conversation, track mood patterns over time, and offer personalized suggestions. Just chat with me naturally and I'll do the rest!"
...
def display_mood_tips():
    if not st.session_state.mood_tips:
        st.info("Chat more to receive personalized mood tips!")
        return
    
    st.markdown('<h3 class="sub-header">Mood Tips</h3>', unsafe_allow_html=True)
...
def display_feedback_section():
    ...
    if not st.session_state.feedback_given:
        st.markdown("<p>How is your experience with MoodSense today?</p>", unsafe_allow_html=True)
...
def display_main_app():
    ...
    st.sidebar.markdown('<h3 class="sub-header">Your Mood Stats</h3>', unsafe_allow_html=True)
    ...
    st.sidebar.markdown("**Mood Distribution:**")
    ...
    # Main chat interface
    st.markdown('<h1 class="main-header">MoodSense Chatbot</h1>', unsafe_allow_html=True)
    ...
    # Chat interface
    st.markdown('<h3 class="sub-header">Chat with MoodSense</h3>', unsafe_allow_html=True)
    ...
    with chat_container:
        ...
        if not st.session_state.welcome_shown:
            welcome_msg = f"Hello {st.session_state.username}! I'm MoodSense, your emotional analysis companion. How are you feeling today?"
